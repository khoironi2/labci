...
class RegistrasiPemeriksaanPerusahaanController extends Controller
{
    //
    ...
    public function index()
    {
        ...
        return view('rolesviews.poli.registrasiperusahaanpemeriksaan', [
...
public function store(Request $request)
{
    ...
    return redirect()->route('registrasi-perusahaan')->with('success', 'Data pemeriksaan dan transaksi berhasil disimpan');
}
