...
<table style="margin-top: 20px; border: none; border-collapse: collapse; font-size: 25px;">
    <tr>
        <td colspan="2" style="text-align: center; background-color: #7f8988; color: rgb(0, 0, 0); border: none; border-collapse: collapse;">
            <b>DATA PASIEN</b>
        </td>
...
<table style="margin-top: 20px; border: none; border-collapse: collapse; font-size: 25px;">
    <tr>
        <td  style="text-align: center; background-color: #7f8988; color: rgb(0, 0, 0); border: none; border-collapse: collapse;">
            <b>TEAM DOKTER MCU</b>
        </td>
...
<table class="detail" style="border: none; font-size:17px;">
    <thead>
        <tr>
            <th style="background-color: #7f8988; color: rgb(0, 0, 0); width: 30%;">Kesimpulan dan Saran</th>
        </tr>
    </thead>
    <tbody>
        <tr>
            <td style="border-bottom:none;">
                <br>
                <span style="background-color: #7f8988; width:500px; margin-top:10%;" >Penilaian</span>
        ...
        <tr>
            <td style="border-bottom:none; border-top:none;">
                <span style="background-color: #7f8988; width:500px;" >Kesimpulan</span>
                <br>
                {{-- Tampilkan Penilaian --}}
                @if ($dataKesimpulanmcu)
        ...
        <tr>
            <td style="border-bottom:none; border-top:none;" >
                <span style="background-color: #7f8988; width:500px;" >Saran</span>
                <br>
                {{-- Tampilkan Penilaian --}}
                @if ($dataKesimpulanmcu)
        ...
        <tr>
            <td style=" border-top:none;">
                <span style="background-color: #7f8988; width:500px;" >Catatan</span>
                <br>
                {{-- Tampilkan Penilaian --}}
                @if ($dataKesimpulanmcu)
                ...
                @foreach ($filteredData as $index => $kesimpulan)
                    ...
                    <tr>
                        <td style="border: none; text-align: left">
                            ...
                            <span>Dokter Penanggung Jawab : {{ $kesimpulan->dokterPenanggungJawab->gelardepan ?? 'N/A' }} {{ $kesimpulan->dokterPenanggungJawab->nama_lengkap ?? 'N/A' }} {{ $kesimpulan->dokterPenanggungJawab->gelarbelakang ?? 'N/A' }}</span>
                        </td>
                    </tr>
                @endforeach
            @endif
