                        ...
                        <div class="card-body p-3">
                            ...
                            <div class="row p-3 border border-primary ">
                                ...
                                <div class="p-3 row justify-content-start">
                                    <form class="col" action="{{ route('riwayat-pemeriksaan-perusahaan-search', ['search' => '1']) }}" method="GET">
                                        <button type="submit" class="btn btn-outline-primary ">Belum Diproses</button>
                                    </form>
                                    <form class="col" action="{{ route('riwayat-pemeriksaan-perusahaan-search', ['search' => '2']) }}" method="GET">
                                        <button type="submit" class="btn btn-outline-warning">Menunggu Direview</button>
                                    </form>
                                    <form class="col" action="{{ route('riwayat-pemeriksaan-perusahaan-search', ['search' => '3']) }}" method="GET">
                                        <button type="submit" class="btn btn-outline-info">Proses Direview</button>
                                    </form>
                                    <form class="col" action="{{ route('riwayat-pemeriksaan-perusahaan-search', ['search' => '6']) }}" method="GET">
                                        <button type="submit" class="btn btn-outline-success">Selesai</button>
                                    </form>
                                    <form class="col" action="{{ route('riwayat-pemeriksaan-perusahaan-search', ['search' => '5']) }}" method="GET">
                                        <button type="submit" class="btn btn-outline-danger">Menunggu Pembayaran</button>
                                    </form>
                                </div>
                                ...
                                <table id="myTable" class="table table-striped border-primary table-hover table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $pemeriksaan->dokter->gelardepan ?? '' }} {{ $pemeriksaan->dokter->nama_lengkap ?? 'Perusahaan' }} {{ $pemeriksaan->dokter->gelarbelakang ?? '' }}</td>
