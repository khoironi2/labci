...
<div class="row" style="display: flex; align-items: center; margin-top: 20px; margin-left: 10%">
    <!-- Kolom kiri untuk data pasien -->
    <div class="col-md-6" style="width: 50%; padding-right: 20px;">
        <table style="width: 100%; border: none; border-collapse: collapse; font-size: 20px;">
            <tr>
                <td style="text-align: left; border: none; padding-bottom: 10px;">NAMA</td>
                <td style="border: none; padding-bottom: 10px;">: <b>{{ $dataPemeriksaan->pasiens->nama }}</b></td>
            </tr>
            <tr>
                <td style="text-align: left; border: none; padding-bottom: 10px;">Tanggal Lahir</td>
                <td style="border: none; padding-bottom: 10px;">: <b>{{ $dataPemeriksaan->pasiens->tanggal_lahir }}</b></td>
            </tr>
            <tr>
                <td style="text-align: left; border: none; padding-bottom: 10px;">JENIS KELAMIN</td>
            ...
            <tr>
                <td style="text-align: left; border: none; padding-bottom: 10px;">NIK</td>
                <td style="border: none; padding-bottom: 10px;">: <b>{{ $dataPemeriksaan->pasiens->no_identitas }}</b></td>
            </tr>
            <tr>
                <td style="text-align: left; border: none; padding-bottom: 10px;">Tanggal MCU</td>
                <td style="border: none; padding-bottom: 10px;">: <b>{{ $dataPemeriksaan->created_at->translatedFormat('d/F/Y') }}</b></td>
            </tr>
        </table>
    </div>

    <!-- Kolom kanan untuk gambar -->
    <div class="col-md-6" style="width: 50%; text-align: center;">
        <img src="/{{ $dataPemeriksaan->pasiens->gambar_pasiens }}" alt="{{ $dataPemeriksaan->pasiens->gambar_pasiens }}" style="height: 200px; max-width: 100%; border: 1px solid #ddd; border-radius: 10px; padding: 5px;">
    </div>
</div>
